    ...
    dbc.Container([
        dbc.Col([
          dbc.Row([
            ...
            placeholder = 'Start-date',style = {'border-radius':'50px', 'text-align':'center'})],
            style = {'text-align':'center'})),
             dbc.Col(html.Div([html.Label('Input endDate'),
                               dcc.DatePickerSingle(id = 'end-date', date= '2023-12-29',
                            placeholder = 'End-date',style ={'border-radius':'50px', 'text-align':'center'})],
                            style = {'text-align':'center'})),
